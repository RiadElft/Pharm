...
<head>
    ...
    <title>Ajouter un Produit - Gestion de Pharmacie</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <div id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-30 flex flex-col transition-transform duration-300 ease-in-out">
        ...
        <nav class="flex-1 px-4 py-6">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="Produits" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-[color:var(--pharmacy-green)]/10 text-[color:var(--pharmacy-green)] font-medium"><svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/></svg>Articles</a>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <!-- Main Content -->
        <div class="px-8 py-6">
            <?php /** @var array $categories, $fournisseurs */ ?>
            <div class="max-w-xl mx-auto py-10">
                <h2 class="text-xl font-bold mb-6">Ajouter un article</h2>
                <form method="POST" action="Produits/create" class="bg-white rounded-xl shadow p-6 space-y-4">
                    <div>
                        <label class="block text-gray-700">Nom</label>
                        <input type="text" name="nom" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-200" />
                    </div>
                    <div>
                        <label class="block text-gray-700">Prix (€)</label>
                        <input type="number" name="prix" step="0.01" min="0" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-200" />
                    </div>
                    <div>
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Créer</button>
                    </div>
                </form>
            </div>
        </div>
