...
<head>
    ...
    <title>Ajouter un Fournisseur - Gestion de Pharmacie</title>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    <form action="/fournisseurs/create" method="post" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="contact" name="contact" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" id="email" name="email" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="telephone" class="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
                            <input type="tel" id="telephone" name="telephone" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="adresse" class="block text-sm font-medium text-gray-700 mb-1">Adresse</label>
                            <textarea id="adresse" name="adresse" rows="3" class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent"></textarea>
                        </div>
