...
<head>
    ...
    <title>Modifier un Fournisseur - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/fournisseurs" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-full font-semibold hover:bg-gray-200 transition">Retour à la liste</a>
        ...
        <div class="px-8 py-6">
            ...
            <div class="max-w-2xl mx-auto py-10">
                <div class="flex items-center mb-6">
                    <a href="/fournisseurs" class="mr-2 text-gray-500 hover:text-[color:var(--pharmacy-green)]">
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    <form action="/fournisseurs/update/<?= $fournisseur['id'] ?>" method="post" class="space-y-4">
                        <div>
                            <label for="nom" class="block text-sm font-medium text-gray-700 mb-1">Nom</label>
                            <input type="text" id="nom" name="nom" value="<?= htmlspecialchars($fournisseur['nom']) ?>" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="contact" class="block text-sm font-medium text-gray-700 mb-1">Contact</label>
                            <input type="text" id="contact" name="contact" value="<?= htmlspecialchars($fournisseur['contact']) ?>" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" id="email" name="email" value="<?= htmlspecialchars($fournisseur['email']) ?>" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="telephone" class="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
                            <input type="tel" id="telephone" name="telephone" value="<?= htmlspecialchars($fournisseur['telephone']) ?>" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
                            <label for="adresse" class="block text-sm font-medium text-gray-700 mb-1">Adresse</label>
                            <textarea id="adresse" name="adresse" rows="3" class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent"><?= htmlspecialchars($fournisseur['adresse']) ?></textarea>
                        </div>
                        <div class="flex justify-end pt-4">
                            <a href="/fournisseurs" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-full font-medium hover:bg-gray-200 transition mr-2">Annuler</a>
