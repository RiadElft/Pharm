...
<head>
    ...
    <title>Fournisseurs - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/fournisseurs/create" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Ajouter un fournisseur</a>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php foreach ($fournisseurs as $fournisseur): ?>
                                <tr>
                                    <td class="px-4 py-2"><?= htmlspecialchars($fournisseur['nom']) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars($fournisseur['contact']) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars($fournisseur['email']) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars($fournisseur['telephone']) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars($fournisseur['adresse']) ?></td>
                                    <td class="px-4 py-2">
                                        <a href="/fournisseurs/edit/<?= $fournisseur['id'] ?>" class="text-blue-600 hover:underline mr-2">Modifier</a>
                                        <a href="/fournisseurs/delete/<?= $fournisseur['id'] ?>" class="text-red-600 hover:underline" onclick="return confirm('Supprimer ce fournisseur ?');">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
