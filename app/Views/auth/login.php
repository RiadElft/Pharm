        ...
        <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Ou
                    <a href="/register" class="font-medium text-[color:var(--pharmacy-green,#3A8D2F)] hover:text-green-700">
            ...
            <form class="mt-8 space-y-6" action="/auth/login" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="/password/forgot" class="font-medium text-[color:var(--pharmacy-green,#3A8D2F)] hover:text-green-700">
                            Mot de passe oublié?
                        </a>
                    </div>
                </div>
