...
<head>
    ...
    <title>Clients - Gestion de Pharmacie</title>
    ...
    <div id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-30 flex flex-col transition-transform duration-300 ease-in-out">
        ...
        <nav class="flex-1 px-4 py-6">
            <ul class="space-y-2">
                ...
                <li><a href="/clients" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-[color:var(--pharmacy-green)]/10 text-[color:var(--pharmacy-green)] font-medium"><svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"/><path d="M5.5 21a7.5 7.5 0 0113 0"/></svg>Clients</a></li>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/clients/create" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Ajouter un client</a>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php foreach ($clients as $client): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="/clients/edit/<?= $client['id'] ?>" class="text-blue-600 hover:underline mr-2">Modifier</a>
                                        <a href="/clients/delete/<?= $client['id'] ?>" class="text-red-600 hover:underline" onclick="return confirm('Supprimer ce client ?');">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
