...
<head>
    ...
    <title><?= $title ?? 'Modifier le Client' ?> - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <div class="px-8 py-6">
            <div class="max-w-2xl mx-auto py-10">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">Modifier le Client</h2>
                ...
                <form method="POST" action="/clients/edit/<?= htmlspecialchars($client['id']) ?>" class="bg-white rounded-xl shadow p-6 space-y-6" id="clientForm">
                    ...
                    <div>
                        ...
                        <textarea name="adresse" id="adresse" rows="3"
                                  class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                  placeholder="Adresse complète"><?= htmlspecialchars($client['adresse'] ?? '') ?></textarea>
                    </div>
