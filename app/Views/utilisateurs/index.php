...
<head>
    ...
    <title>Utilisateurs - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/utilisateurs/create" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Nouvel Utilisateur</a>
                            ...
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2 flex space-x-2">
                                        <a href="/utilisateurs/edit/<?= $user['id'] ?>" class="text-blue-600 hover:underline">Modifier</a>
                                        <a href="/utilisateurs/delete/<?= $user['id'] ?>" class="text-red-600 hover:underline" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur?')">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
