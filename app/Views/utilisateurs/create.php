...
<head>
    ...
    <title>Nouvel Utilisateur - Gestion de Pharmacie</title>
        ...
        <div class="px-8 py-6">
            ...
            <div class="max-w-2xl mx-auto py-10">
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    <form action="/utilisateurs/store" method="post" class="space-y-4">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="password" id="password" name="password" required class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent">
                        </div>
                        <div>
