...
<head>
    ...
    <title>Ventes - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/ventes/create" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Nouvelle vente</a>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php foreach ($ventes as $vente): ?>
                                <tr>
                                    <td class="px-4 py-2"><?= htmlspecialchars((string)($vente['id'] ?? '')) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars((string)($vente['client_nom'] ?? 'Client inconnu')) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars((string)($vente['produits'] ?? 'Aucun produit')) ?></td>
                                    <td class="px-4 py-2"><?= htmlspecialchars((string)($vente['date_vente'] ?? '')) ?></td>
                                    <td class="px-4 py-2"><?= number_format((float)($vente['montant_total'] ?? 0), 0, ',', ' ') ?> DA</td>
                                    <td class="px-4 py-2">
                                        <?php
                                        $status = $vente['statut'] ?? 'en_cours';
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex items-center gap-2">
                                            <a href="/ventes/view/<?= $vente['id'] ?? 0 ?>" class="text-blue-600 hover:underline">Voir</a>
                                            <a href="/ventes/delete/<?= $vente['id'] ?? 0 ?>" 
