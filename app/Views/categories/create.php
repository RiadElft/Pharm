...
<head>
    ...
    <title>Ajouter une Catégorie - Gestion de Pharmacie</title>
                ...
                <div class="bg-white rounded-xl shadow p-6">
                    <form action="/categories/create" method="post" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="w-full rounded-lg border-gray-300 border p-2 focus:ring-2 focus:ring-[color:var(--pharmacy-green)] focus:border-transparent"></textarea>
                        </div>
