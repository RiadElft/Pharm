...
<head>
    ...
    <title>Catégories - Gestion de Pharmacie</title>
    ...
    <div id="main-content" class="transition-all duration-300 ease-in-out ml-64">
        ...
        <header class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
            ...
            <div class="flex items-center gap-4">
                <a href="/categories/create" class="bg-[color:var(--pharmacy-green,#3A8D2F)] text-white px-4 py-2 rounded-full font-semibold hover:bg-green-700 transition">Ajouter une catégorie</a>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php foreach ($categories as $categorie): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2"><?= htmlspecialchars($categorie['description']) ?></td>
                                    <td class="px-4 py-2">
                                        <a href="/categories/edit/<?= $categorie['id'] ?>" class="text-blue-600 hover:underline mr-2">Modifier</a>
                                        <a href="/categories/delete/<?= $categorie['id'] ?>" class="text-red-600 hover:underline" onclick="return confirm('Supprimer cette catégorie ?');">Supprimer</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
