            ...
            <div class="max-w-xl mx-auto py-10">
                ...
                <form method="POST" action="/Produits/create" class="bg-white rounded-xl shadow p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="prix" step="1" min="0" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-200" />
                    </div>
                    <div>
